...
#if defined(PSOC_HASH_SHA2)
    wc_Psoc_Sha1_Sha2_Init(dst, WC_PSOC_SHA512, 0);
#endif
...
#if !defined(STM32_HASH_SHA512_224) && !defined(PSOC_HASH_SHA2)
...
#if !defined(STM32_HASH_SHA512_256) && !defined(PSOC_HASH_SHA2)
...
#if defined(PSOC_HASH_SHA2)
    wc_Psoc_Sha1_Sha2_Init(dst, WC_PSOC_SHA384, 0);
#endif
